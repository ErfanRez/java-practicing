...
public class SplayTree
{
    ...
    /** rotate **/
    public void makeLeftChildParent(TreeNode c, TreeNode p)
    {
    ...
    /** rotate **/
    public void makeRightChildParent(TreeNode c, TreeNode p)
    {
    ...
    private TreeNode findNode(int ele)
    {
    ...
    /**function for printing sideways**/
    ...
    private void printSideways(TreeNode p, String indent){
        if (p!=null)
        {
            ...
            System.out.println(indent + p.element);
