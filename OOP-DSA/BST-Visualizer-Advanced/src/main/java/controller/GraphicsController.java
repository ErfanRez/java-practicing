...
public final class GraphicsController implements Initializable {
	...
	@FXML private void searchOnAction(ActionEvent event) {
		try {
			graphicsTree.search(Integer.valueOf(Integer.parseInt(input_field.getText().trim())));
	...
	@FXML private void deleteOnAction(ActionEvent event) {
		try {
			graphicsTree.delete(Integer.valueOf(Integer.parseInt(input_field.getText().trim())));
		} catch (NumberFormatException nfe) {
	...
	@FXML private void insertOnAction(ActionEvent event) {
		try {
			graphicsTree.insert(Integer.valueOf(Integer.parseInt(input_field.getText().trim())));
		} catch (NumberFormatException nfe) {
